...
do
        ...
        do
                ...
                cp -v GROUPZIP/CONSOLIDACAO_${BIOMA}_${ANO}.zip /gcstorage/mapbiomas-group/COLECAO/BIOMA_ANO_ZIP/CONSOLIDACAO_${BIOMA}_${ANO}.zip
                cp -v GROUPZIP/CLASSIFICACAOFT_${BIOMA}_${ANO}.zip /gcstorage/mapbiomas-group/COLECAO/BIOMA_ANO_ZIP/CLASSIFICACAOFT_${BIOMA}_${ANO}.zip
                cp -v GROUPZIP/CLASSIFICACAO_${BIOMA}_${ANO}.zip /gcstorage/mapbiomas-group/COLECAO/BIOMA_ANO_ZIP/CLASSIFICACAO_${BIOMA}_${ANO}.zip
