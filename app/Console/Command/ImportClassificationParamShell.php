...
class ImportClassificationParamShell extends AppShell
{
    ...
    private function factoryClassificationDataModel($paramJson)
    {
        ...
        $ndado['Classificacao']['t0'] = $t0[1] . "/" . $t0[2] . "/" . $t0[0]; 
        // "2000-01-30" => "01/30/2000" / (aaaa-mm-dd) => (mm/dd/aaaa)
                                                                             
        $t1 = explode("-", $paramJson['T1']);

        $ndado['Classificacao']['t1'] = $t1[1] . "/" . $t1[2] . "/" . $t1[0]; 
        // "2000-01-30" => "01/30/2000" / (aaaa-mm-dd) => (mm/dd/aaaa)
        ...
        $ndado['Classificacao']['identificador'] = $paramJson['LABEL'] . ' csvimport';
        $ndado['Classificacao']['colecao_id']    = '4';
        $ndado['Classificacao']['elevation_max'] = $paramJson['ELEVATION_MAX'];
